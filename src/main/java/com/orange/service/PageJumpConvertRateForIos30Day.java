...
public class PageJumpConvertRateForIos30Day {
...
private  JavaRDD<Row> generateRDD(SparkSession spark) {
	 JavaRDD<String> pageRDD = spark.sparkContext().textFile("hdfs://master:9000/user/hadoop/bingbing/ios/pagedata30day.txt", 1).toJavaRDD();
...
PageSplitConvertRate pageSplitConvertRate2 = new PageSplitConvertRate();
	...
	//执行插入方法
	IosPageSplitConvertRateDAOImpl30Day pageSplitConvertRateDAO = daoFactory.getIosPageSplitConvertRateDAO30Day();
