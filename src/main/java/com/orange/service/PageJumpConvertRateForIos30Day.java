...
import com.orange.dao.impl.IosPageSplitConvertRateDAOImpl30Day;
	...
	public class PageJumpConvertRateForIos30Day implements Serializable{
		
		private static final long serialVersionUID = 1L;

	public  void pageJumpConvertRateForIos30Day() {
		//1.构建sparksession
	...
	private  JavaRDD<Row> generateRDD(SparkSession spark) {
		 JavaRDD<String> pageRDD = spark.sparkContext().textFile(Constants.HDFS_URL_IOS_30D, 1).toJavaRDD();
	...
	PageSplitConvertRate pageSplitConvertRate2 = new PageSplitConvertRate();
		...
		//执行插入方法
		 IosPageSplitConvertRateDAO iosPageSplitConvertRateDAO30Day = daoFactory.getIosPageSplitConvertRateDAO30Day();
		 iosPageSplitConvertRateDAO30Day.insert(pageSplitConvertRate2); 
		 }
		}
