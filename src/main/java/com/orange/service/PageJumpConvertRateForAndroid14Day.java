...
private  JavaRDD<Row> generateRDD(SparkSession spark) {
	 JavaRDD<String> pageRDD = spark.sparkContext().textFile("hdfs://master:9000/user/hadoop/bingbing/android/pagedata14day.txt", 1).toJavaRDD();
...
PageSplitConvertRate pageSplitConvertRate2 = new PageSplitConvertRate();
	...
	//执行插入方法
	AndroidPageSplitConvertRateDAOImpl14Day pageSplitConvertRateDAO = daoFactory.getAndroidPageSplitConvertRateDAO14Day();
