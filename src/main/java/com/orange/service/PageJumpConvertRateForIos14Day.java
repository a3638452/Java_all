...
import com.orange.dao.impl.IosPageSplitConvertRateDAOImpl14Day;
	...
	public class PageJumpConvertRateForIos14Day implements Serializable {
	...
	PageSplitConvertRate pageSplitConvertRate2 = new PageSplitConvertRate();
		...
		//执行插入方法
		IosPageSplitConvertRateDAO iosPageSplitConvertRateDAO14Day = daoFactory.getIosPageSplitConvertRateDAO14Day();
		iosPageSplitConvertRateDAO14Day.insert(pageSplitConvertRate2); 
		 }
		}
		}
