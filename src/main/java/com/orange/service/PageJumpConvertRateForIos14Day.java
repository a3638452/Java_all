...
private  JavaRDD<Row> generateRDD(SparkSession spark) {
	 JavaRDD<String> pageRDD = spark.sparkContext().textFile("hdfs://master:9000/user/hadoop/bingbing/ios/pagedata14day.txt", 1).toJavaRDD();
...
PageSplitConvertRate pageSplitConvertRate2 = new PageSplitConvertRate();
	...
	//执行插入方法
	IosPageSplitConvertRateDAOImpl14Day pageSplitConvertRateDAO = daoFactory.getIosPageSplitConvertRateDAO14Day();
