...
public class PageJumpConvertRateForAndroid30Day {

public  void PageJumpConvertRateForAndroid30Day() {
	//1.构建sparksession
    ...
    //2.获取任务参数
	  ...
	  Long firstPage = Long.valueOf(firstPV.substring(1, firstPV.length()-1));
	  //8.计算convertRateMap
...
private  SparkSession getSparkSession() {
    ...
    SparkSession spark = SparkSession
      .builder()
      .appName("PageJumpConvertRateForAndroid30Day")
...
private  JavaRDD<Row> generateRDD(SparkSession spark) {
	 JavaRDD<String> pageRDD = spark.sparkContext().textFile("hdfs://master:9000/user/hadoop/bingbing/android/pagedata30day.txt", 1).toJavaRDD();
	    ...
	    JavaRDD<Row> rowRDDs = spark.sql("select userid,pagename,logintime from pagedata where logintime is not null sort by logintime").javaRDD();
		return rowRDDs;
}
...
Map<String, Integer> splitPvMap2 = splitAndPV.reduceByKeyLocally(new Function2<Integer, Integer, Integer>() {
...
PageSplitConvertRate pageSplitConvertRate2 = new PageSplitConvertRate();
	...
	//执行插入方法
	AndroidPageSplitConvertRateDAOImpl30Day pageSplitConvertRateDAO = daoFactory.getAndroidPageSplitConvertRateDAO30Day();
...
PageSplitConvertRate2 pageSplitConvertRate2 = new PageSplitConvertRate2();
	...
	//执行插入方法
	AndroidPageSplitConvertRateDAO pageSplitConvertRateDAO = DAOFactory.getPageSplitConvertRateDAO();
	pageSplitConvertRateDAO.insert(pageSplitConvertRate2); }
	}*/
