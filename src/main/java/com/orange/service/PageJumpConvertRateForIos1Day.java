...
import com.orange.dao.impl.IosPageSplitConvertRateDAOImpl1Day;
	...
	public class PageJumpConvertRateForIos1Day implements Serializable{
	...
	PageSplitConvertRate pageSplitConvertRate2 = new PageSplitConvertRate();
		...
		//执行插入方法
	   IosPageSplitConvertRateDAO iosPageSplitConvertRateDAO1Day = daoFactory.getIosPageSplitConvertRateDAO1Day();
	   iosPageSplitConvertRateDAO1Day.insert(pageSplitConvertRate2); 
		 }
		}
		}
